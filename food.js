classActive{
staticgetincrement(){return1;}
staticgetdecrement(){return2;}
staticgetopenProductModal(){return3;}
staticgetcloseProductModal(){return4;}
}


//#region------------------------------全域變數------------------------------
//lettheMenu=[];//存放菜單的陣列(sortbycatId)
lettheProducts=[];//存放菜單的陣列(sortbyproductId)
lettheUserOrders=[];//客人的歷史訂單
//lettheFoodAdditions=[];//食物附加選項
constexpireMins=30;//登入過期時間(分鐘)
//consturlDomain='http://localhost:3000';
consturlDomain='https://json-server-vercel-a.vercel.app';

letsumPrice=0;//總價格
lettheNotDoneOrders=[];//未完成的客戶訂單資料
lettheAllOrders=[];//全部的客戶訂單
lettheDoneOrders=[];//已完成的客戶訂單資料
lettheMenu=[];//存放菜單的陣列(sortbycatId)(cat底下再放products)
lettheCats=[];//商品類別
lettheFoodAdditions=[];//食品附加選項
...
theMenu=[
	{"id":"c01",	"name":"蛋餅",	"products":[
		{"id":"p012",	"catId":"c01",	"name":"玉米蛋餅",		"price":30,	"comment":"手工蛋餅皮+滿滿玉米",		"img":"./Img/PC/p012.jpg",	"additionIds":["AH01"],	"isSoldOut":false},	
		{"id":"p013",	"catId":"c01",	"name":"培根蛋餅",		"price":35,	"comment":"手工蛋餅皮+雙份培根",		"img":"./Img/PC/p013.jpg",	"additionIds":["AH01"],	"isSoldOut":false},	
		{"id":"p014",	"catId":"c01",	"name":"火腿蛋餅",		"price":35,	"comment":"手工蛋餅皮+整條火腿",		"img":"./Img/PC/p014.jpg",	"additionIds":["AH01"],	"isSoldOut":false},	
		{"id":"p015",	"catId":"c01",	"name":"鮪魚沙拉蛋餅",	"price":35,	"comment":"手工蛋餅皮+一整罐鮪魚",		"img":"./Img/PC/p015.jpg",	"additionIds":["AH01"],	"isSoldOut":false},	
		{"id":"p016",	"catId":"c01",	"name":"起司蛋餅",		"price":35,	"comment":"手工蛋餅皮+爆漿起司",		"img":"./Img/PC/p016.jpg",	"additionIds":["AH01"],	"isSoldOut":false}]},	
	...
	{"id":"c05",	"name":"點心",	"products":[
		{"id":"p051",	"catId":"c05",	"name":"歡樂薯餅",		"price":10,	"comment":"薯餅薯餅得第一",				"img":"./Img/PC/p051.jpg",	"additionIds":["AH01","AH04"],	"isSoldOut":false},	
	...
	{"id":"c06",	"name":"飲品",	"products":[
		{"id":"p061",	"catId":"c06",	"name":"早餐店奶茶",	"price":15,	"comment":"台灣特色，早餐店奶茶",		"img":"./Img/PC/p061.jpg",	"additionIds":["AH02","AH03","AH04"],	"isSoldOut":false},	
		{"id":"p062",	"catId":"c06",	"name":"經典紅茶",		"price":15,	"comment":"台灣高山茶葉沖泡",			"img":"./Img/PC/p062.jpg",	"additionIds":["AH01","AH02","AH03"],	"isSoldOut":false}]}]
