	...
	function renderRevenueAnalysis() {
		...
		theCategory.map((cat, index) => {
			...
			if (index == 0) {
				...
				obj = <option key={index} value="${cat.catId}">${cat.catName}</option>
			return obj
		});
							...
							<svg width="531.2" height="320" style={{ overflow: "hidden" }}>
								<g transform="translate(60.5,4.5)">
									...
									<g clipPath="url(http://localhost:5568/backstage.html#c3-1727121227311-clip)" className="c3-chart">
										...
										<g className="c3-event-rects" style={{ "fillOpacity": 0 }}><rect className="c3-event-rect" x="0" y="0" width="401.2" height="266" ></rect></g>
										<g className="c3-chart-bars">
											<g className="c3-chart-bar c3-target c3-target-銷量" style={{ "pointerEvents": "none" }}>
											...
											<g className="c3-chart-bar c3-target c3-target-金額" style={{ "pointerEvents": "none" }}>
										...
										<g className="c3-chart-lines">
											<g className="c3-chart-line c3-target c3-target-銷量" style={{ opacity: 1, "pointerEvents": "none" }}>
											...
											<g className="c3-chart-line c3-target c3-target-金額" style={{ opacity: 1, "pointerEvents": "none" }}>
										...
										<g className="c3-chart-arcs" transform="translate(200.6,128)">
											<text className="c3-chart-arcs-title" style={{ "textAnchor": "middle", opacity: 0 }}></text></g>
										<g className="c3-chart-texts">
											<g className="c3-chart-text c3-target c3-target-銷量  " style={{ opacity: 1, "pointerEvents": "none" }}>
												<g className=" c3-texts c3-texts-銷量">
													<text className=" c3-text c3-text-0" textAnchor="middle" x="9.775" y="228.58" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>2</text>
													<text className=" c3-text c3-text-1" textAnchor="middle" x="43.775" y="211.37662337662337" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>3</text>
													<text className=" c3-text c3-text-2" textAnchor="middle" x="76.775" y="245.8" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>1</text>
													<text className=" c3-text c3-text-3" textAnchor="middle" x="110.775" y="245.8" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>1</text>
													<text className=" c3-text c3-text-4" textAnchor="middle" x="143.775" y="228.58" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>2</text>
													<text className=" c3-text c3-text-5" textAnchor="middle" x="177.775" y="228.58" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>2</text>
													<text className=" c3-text c3-text-6" textAnchor="middle" x="210.775" y="22.1" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>14</text>
													<text className=" c3-text c3-text-7" textAnchor="middle" x="244.775" y="245.8" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>1</text>
													<text className=" c3-text c3-text-8" textAnchor="middle" x="277.775" y="228.58" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>2</text>
													<text className=" c3-text c3-text-9" textAnchor="middle" x="310.775" y="228.58" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>2</text>
													<text className=" c3-text c3-text-10" textAnchor="middle" x="344.775" y="142.55" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>7</text>
													<text className=" c3-text c3-text-11" textAnchor="middle" x="377.775" y="194.17" style={{ stroke: "none", fill: "rgb(31, 119, 180)", "fillOpacity": 1 }}>4</text></g>
											</g>
											<g className="c3-chart-text c3-target c3-target-金額  " style={{ opacity: 1, "pointerEvents": "none" }}>
												<g className=" c3-texts c3-texts-金額">
													<text className=" c3-text c3-text-0" textAnchor="middle" x="24.225" y="153.5" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$100</text>
													<text className=" c3-text c3-text-1" textAnchor="middle" x="58.225" y="137.1" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$115</text>
													<text className=" c3-text c3-text-2" textAnchor="middle" x="91.225" y="246.57438016528926" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$15</text>
													<text className=" c3-text c3-text-3" textAnchor="middle" x="125.225" y="202.77" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$55</text>
													<text className=" c3-text c3-text-4" textAnchor="middle" x="158.225" y="22.1" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$220</text>
													<text className=" c3-text c3-text-5" textAnchor="middle" x="192.225" y="87.79338842975206" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$160</text>
													<text className=" c3-text c3-text-6" textAnchor="middle" x="225.225" y="109.7" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$140</text>
													<text className=" c3-text c3-text-7" textAnchor="middle" x="259.225" y="230.1487603305785" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$30</text>
													<text className=" c3-text c3-text-8" textAnchor="middle" x="292.225" y="197.3" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$60</text>
													<text className=" c3-text c3-text-9" textAnchor="middle" x="325.225" y="197.3" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$60</text>
													<text className=" c3-text c3-text-10" textAnchor="middle" x="359.225" y="115.1694214876033" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$135</text>
													<text className=" c3-text c3-text-11" textAnchor="middle" x="392.225" y="197.3" style={{ stroke: "none", fill: "rgb(255, 127, 14)", "fillOpacity": 1 }}>$60</text></g>
											</g>
										</g>
									</g>
								...
								<g transform="translate(0,300)">
									<g className="c3-legend-item c3-legend-item-銷量" style={{ visibility: "visible", cursor: "pointer" }}>
										<text x="247.6" y="9" style={{ "pointerEvents": "none" }}>銷量</text><rect className="c3-legend-item-event" x="233.6" y="-5" width="49" height="17.6" style={{ "fillOpacity": 0 }}></rect>
										<line className="c3-legend-item-tile" x1="231.6" y1="4" x2="241.6" y2="4" strokeWidth="10" style={{ stroke: "rgb(31, 119, 180)", "pointerEvents": "none" }}></line></g>
									<g className="c3-legend-item c3-legend-item-金額" style={{ visibility: "visible", cursor: "pointer" }}>
										<text x="296.6" y="9" style={{ "pointerEvents": "none" }}>金額</text><rect className="c3-legend-item-event" x="282.6" y="-5" width="39" height="17.6" style={{ "fillOpacity": 0 }}></rect>
										<line className="c3-legend-item-tile" x1="280.6" y1="4" x2="290.6" y2="4" strokeWidth="10" style={{ stroke: "rgb(255, 127, 14)", "pointerEvents": "none" }}></line></g>
								</g>
							</svg>
							<div className="c3-tooltip-container" style={{ position: "absolute", "pointerEvents": "none", display: "none", top: "144.7px", left: "350.7px" }}><table className="c3-tooltip"><tbody>
								...
								<svg width="350" height="320" style={{ overflow: "hidden" }}><defs>
									...
									<g transform="translate(0,300)">
										<g className="c3-legend-item c3-legend-item-蛋餅" style={{ visibility: "visible", cursor: "pointer" }}>
											<text x="47" y="9" style={{ "pointerEvents": "none" }}>蛋餅</text><rect className="c3-legend-item-event" x="33" y="-5" width="49" height="17.6" style={{ "fillOpacity": 0 }}></rect>
											<line className="c3-legend-item-tile" x1="31" y1="4" x2="41" y2="4" strokeWidth="10" style={{ stroke: "rgb(31, 119, 180)", "pointerEvents": "none" }}></line></g>
									</g>
									<text className="c3-title" x="175" y="0"></text></svg>
								<div className="c3-tooltip-container" style={{ position: "absolute", "pointerEvents": "none", display: "none" }}></div></div>
